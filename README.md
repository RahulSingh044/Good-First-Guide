...
[![Contributions Welcome](https://img.shields.io/badge/contributions-welcome-brightgreen.svg?style=flat)](https://github.com/RahulSingh044/Good-First-Guide/issues)
...
```mermaid
graph LR
    A[GFG Website] -->|vscode:// deep link| B[VS Code Extension]
    B --> C[GitHub Auth]
    B --> D[Fork Repo]
    B --> E[Clone Repo]
    B --> F[Create Branch]
